...
public class Customer {
    ...
    public void sayBye() {
        System.out.printf("손님: 아..그럼, 다음에 올게요~ 기분이 %s이고, 잔액 %d 남았습니다.\n", this.myFeeling, this.cache);
    }
    ...
    public long askAndGetDeliverCostFromDeliveryManger(DeliverManager deliverManager) {
        return deliverManager.answerDeliveryCost();
    }
    ...
    public void wearSneakers(Sneakers sneakers) {
        this.myFeeling = "Good";
        System.out.printf("손님: 이 신발은 %s의 특징이 느껴지네요, 기분이 %s이고, 잔액 %d 남았습니다\n",
                sneakers.getSneakersInfo().getFeature(),
                this.myFeeling,
                this.cache);
    }
