...
public class LambdaTest1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(multipleNum1.calcultate(5));
        System.out.println(multipleNum2.calcultate(5));
        System.out.println(multipleNum3.calcultate(5));
        System.out.println(multipleNum4.calcultate(5));
